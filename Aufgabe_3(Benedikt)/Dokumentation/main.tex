...
\newcommand{\Aufgabe}{Aufgabe 3: Wandertag} % Aufgabennummer und Aufgabennamen angeben
\newcommand{\TeamId}{00153}                       % Team-ID aus dem PMS angeben
\newcommand{\TeamName}{ByteBusters}                 % Team-Namen angeben
\newcommand{\Namen}{Benedikt Wiesner}           % Namen der Bearbeiter/-innen dieser Aufgabe angeben
